...
//				while(i <= f_size(&USBHFile))
//				{
//					fimware_data[i] = *buffer;
//					buffer++;
//					i++;
//				}
//				MY_FLASH_SetSectorAddrs(5, 0x08020000);
//				MY_FLASH_WriteN(0,(uint8_t *)buffer,f_size(&USBHFile),DATA_TYPE_8);
